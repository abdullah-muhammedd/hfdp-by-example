...
export class OwnerUser implements User, Hookable {
  id: string;
  name: string;
  email: string;
  phone: string;
  ...
  preSave() {
    ...
    this.permissions.push(Permissions.DELETE_USER);
    ...
    this.permissions.push(Permissions.DELETE_PROJECT);
    ...
    this.permissions.push(Permissions.DELETE_PROJECT_TASK);
    ...
    this.permissions.push(Permissions.DELETE_PROJECT_TASK_COMMENT);
  }
}
